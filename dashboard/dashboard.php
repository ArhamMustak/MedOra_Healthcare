...
<body>
    ...
    <div id="nav_container">
        ...
        <input id="book_btn" type="button" value="𝗕𝗢𝗢𝗞 𝗡𝗢𝗪!!!">
        <pre id="welcome_pre">
        ...
        <div id="bg_img3_div" ondblclick="scroll_to_top()">
            ...
            <div>
            <p>At Medora, we provide a comprehensive range of healthcare services designed to meet the diverse needs of our community. From preventative 
            screenings to complex surgical interventions, our patient-centric approach ensures you receive the highest standard of medical excellence 
            in a supportive and healing environment.</p>
        ...
        <div id="bg_img4_div" ondblclick="scroll_to_top()">
            ...
            <div>
                <h3>Connecting with expert medical professionals 
            at Medora is simple and secure. 
            To ensure your health records 
            are accurately maintained and kept private, 
            we require all patients to access our consultation 
            portal through a secure 
            account. Once logged in, 
            you can browse our directory of world-class 
            specialists, check real-time availability, 
            and secure your appointment with just a few clicks. </h3>
        ...
        <div id="last_bar" ondblclick="scroll_to_top()">
            ...
            <pre style="font-size: smaller; text-align: center;">
                @2026 Medora holdings PLC. All rights reserved. | Cookie Policy | Data Protection Notice        Web Desing and Development by PROGRAMIZE
            </pre>
        </div>
    </body>
</html>
